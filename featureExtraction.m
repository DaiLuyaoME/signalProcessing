%% 抓取MSD特征，分析窗口大小、滤波器等因素对特征的影响

%% 抓取极大值极小值点
% 极大值抓取策略：阈值
% 极小值抓取策略：阈值 + 是否已经抓取到第一个极大值点 
captureMinMaxPointMultiFile;
%%  计算数据集全部文件极大值、极小值距离和峰峰值
calMSDDistanceAndPeakValue;
%% 多数据文件实时滤波和零相位滤波极值点距离分析
...
analyseEffectOfWindowsizeOnMSD;
